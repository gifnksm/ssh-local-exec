...
async fn handle_client(stream: SocketStream) -> eyre::Result<()> {
    ...
    tokio::spawn(
        crate::task::output(stdin, stdin_res_tx, stdin_bytes_rx)
            .in_current_span()
    ...
    tokio::spawn(
        crate::task::input(stdout, stdout_bytes_tx, stdout_res_rx)
            .in_current_span()
    ...
    tokio::spawn(
        crate::task::input(stderr, stderr_bytes_tx, stderr_res_rx)
            .in_current_span()
